...
if check_password():
    ...
    def show_pdf(file_path):
        ...
        #pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}" width="800" height="800" type="application/pdf" toolbar=0></iframe>'
        pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}" width="800" height="800" type="application/pdf" frameborder=0 scrolling=no></iframe>'
